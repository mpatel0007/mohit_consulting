        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
                <div class="job-alerts-item">
                    ...
                    <nav> 
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Job Details</a>
                            <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Location</a>
                            <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Salary Details</a>
                            <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab" href="#nav-about" role="tab" aria-controls="nav-about" aria-selected="false">Job Type</a>
                        ...
                        <div class="tab-content tab-validate py-3 px-3 px-sm-0" id="nav-tabContent">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" id="jobskill" name="jobskill" required>
                                                    ...
                                                    @foreach ($jobskill as $jobskill)
                                                        <option class="custom-select" value='{{ $jobskill->id }}'
                                                            <?php // if(isset($Jobs_edit_data->jobskill_id)){ if($Jobs_edit_data->jobskill_id == $jobskill->id){echo 'selected';}} ?> >
                                                            {{ $jobskill->jobskill }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div> --}}
                            ...
                            {{-- </div> --}}
                                ...
                                <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                        ...
                                        {{-- <div class="form-group row">
                                            <div class="col-sm-3">
                                                <label for="Yearly Salary">Yearly Salary:</label>
                                            </div>
                                            <div class="col-sm-9">
                                ...
                                <div class="tab-pane fade" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
                                        {{-- <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" id="functional" name="functional" required>
                                                    ...
                                                    <option class="custom-select" value={{$functional->id }} <?php // if(isset($Jobs_edit_data->functional_id)){ if($Jobs_edit_data->functional_id == $functional->id){echo 'selected';}} ?>>{{$functional->functional_area}}</option>
                                                    @endforeach 
                                                </select>
                                    ...
                                    <button type="button" id="next_4" class="btn  removefocus btn-common">Next</button>
                                        ...
                                        <button type="button" id="postJobs" name="postJobs" class="btn  removefocus btn-common">Submit</button>
